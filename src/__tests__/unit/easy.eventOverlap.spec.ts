...
describe('convertEventToDateRange', () => {
  it('일반적인 이벤트를 올바른 시작 및 종료 시간을 가진 객체로 변환한다', () => {
    ...
    expect(result.start).toEqual(parseDateTime('2024-07-01', '14:30'));
    expect(result.end).toEqual(parseDateTime('2024-07-01', '15:30'));
  });
...
describe('findOverlappingEvents', () => {
  it('새 이벤트와 겹치는 모든 이벤트를 반환한다', () => {
    ...
    expect(overlappingEvents).toEqual(existingEvents);
  });
